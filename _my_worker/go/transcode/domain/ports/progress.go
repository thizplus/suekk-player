...
type ProgressUpdate struct {
	...
	// API expects these at top-level, not nested in Output
	OutputPath string `json:"output_path,omitempty"` // HLS path for completed transcode
	AudioPath  string `json:"audio_path,omitempty"`  // Audio file path
}
